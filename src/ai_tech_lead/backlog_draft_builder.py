...
def _backlog_refinement_prompt(
    ...
    *,
    ...
    return (
        ...
        "Repository-managed fields such as Status, Created Date, Creator, "
        "completeness indicators, cleanup flags, and cleanup notes are set by "
        "the repository code after validation. "
